...
(async()=>{
 ...
 try {
  ...
  await page.screenshot({path:'artifacts/white-overview.png',animations:'disabled'});
  ...
  await page.screenshot({path:'artifacts/white-crew-review.png',animations:'disabled'});
  await page.getByRole('button',{name:'Close details'}).click();
  await page.setViewportSize({width:390,height:844});
  await page.screenshot({path:'artifacts/white-mobile.png',animations:'disabled'});
  ...
  console.log('Appearance browser passed: white theme, reference branding, equal map/crew panels, 3D toggles/zoom, mobile, global/scoped building distances; no writes.');
