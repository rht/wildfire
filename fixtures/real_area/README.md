...
- **Value at risk** (`config.FEATURES["value_at_risk"]`, policy value-at-risk-proto-2026-09-19):
  ...
  - `gavarres_real-0001`: 1866.7 people exposed, 0 at risk at p50 and 0 at p10, expected loss EUR 13,280,000 (band 4,980,000 to 26,560,000); of 99 located assets, 12 are left out of the people totals and 0 out of the euro totals for want of an input.
  - `gavarres_real-0002`: 6632.5 people exposed, 0 at risk at p50 and 45 at p10, expected loss EUR 43,390,000 (band 16,290,000 to 86,780,000); of 99 located assets, 12 are left out of the people totals and 0 out of the euro totals for want of an input.
  - `gavarres_real-0003`: 18433.9 people exposed, 1680 at risk at p50 and 3040 at p10, expected loss EUR 137,420,000 (band 51,720,000 to 274,840,000); of 99 located assets, 12 are left out of the people totals and 0 out of the euro totals for want of an input.
  - `gavarres_real-0004`: 0 people exposed, 0 at risk at p50 and 0 at p10, expected loss EUR 0 (band 0 to 0); of 99 located assets, 12 are left out of the people totals and 0 out of the euro totals for want of an input.
